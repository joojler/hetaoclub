...
class main extends AWS_CONTROLLER
{
	...
	{		
		...
		if (TPL::is_output('block/content_question.tpl.htm', 'home/explore'))
		{
			...
			{
				$question_list = $this->model('question')->get_questions_list($_GET['page'], get_setting('contents_per_page'), $_GET['sort_type'], $_GET['topic_id'], $category_info['id'], $_GET['answer_count'], $_GET['day'], $_GET['is_recommend'], $_GET['is_offline']);
			}
